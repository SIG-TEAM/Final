        ...
        <div class="p-6 bg-white border-b border-gray-200">
            <form action="{{ route('kategori.update', $kategori->id) }}" method="POST">
                ...
                <div class="flex items-center justify-end mt-6">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition-colors duration-200">
                        Perbarui Kategori
                    </button>
                </div>
            </form>
