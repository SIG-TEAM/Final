    ...
    <body class="p-0 m-0 font-sans antialiased bg-gray-100" x-data="{ sidebarOpen: false }" @yield('body_attributes')>
        <div class="relative min-h-screen">
            ...
            <button 
                ...
                class="fixed left-0 z-40 p-3 text-white transition-all duration-300 -translate-y-1/2 rounded-full top-1/2 hover:shadow-lg hover:bg-green-700 focus:outline-none"
