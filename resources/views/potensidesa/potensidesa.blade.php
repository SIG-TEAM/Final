        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3>{{ $potensiDesa->nama_potensi }}</h3>
                    <div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset('storage/' . $potensiDesa->gambar) }}" alt="{{ $potensiDesa->nama_potensi }}" class="img-fluid rounded">
                        </div>
                        <div class="col-md-6">
                        @else
                        <div class="col-md-12">
...
<script>
        ...
        const marker = new google.maps.Marker({
            position: position,
            map: map,
            title: "{{ $potensiDesa->nama_potensi }}"
        });
</script>
@endsection